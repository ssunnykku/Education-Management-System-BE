...
public interface AttendanceService {
    ...
    */
    ...
    // -- 데이터 결과 목록 가져오기
    Collection<StudentAttendanceListDTO> getAttendanceIntegratedListFilterAll(String name, int courseNumber, int page, int size);
    // 경우2_ 기수 또는 수강생명 입력
    // -- 데이터 개수 가져오기 (for 페이지네이션)
    int getAttendanceIntegratedListFilterAmount(String name, int courseNumber);
    // -- 데이터 결과 목록 가져오기
    Collection<StudentAttendanceListDTO> getAttendanceIntegratedListFilter(String name, int courseNumber, int page, int size);
    ...
    // -- 데이터 결과 목록 가져오기
    Collection<StudentAttendanceListDTO> getAttendanceIntegratedListNoFilter(String name, int courseNumber, int page, int size);
